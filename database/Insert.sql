...
insert into race (RACE_ID, RACE_NAME, RACE_DATE, ONGOING) values (1, 'Tour Down Under', TO_DATE('2014/05/03', 'yyyy/mm/dd'), 'Y');
insert into race_team (RACE_ID, RIDER_ID, JERSEY_ID) values (1, 1, 1 );
insert into race_team (RACE_ID, RIDER_ID, JERSEY_ID) values (1, 2, 2 );
insert into race_team (RACE_ID, RIDER_ID, JERSEY_ID) values (1, 3, 3 );
insert into race_team (RACE_ID, RIDER_ID, JERSEY_ID) values (1, 4, 4 );
insert into race_team (RACE_ID, RIDER_ID, JERSEY_ID) values (1, 5, 5 );
